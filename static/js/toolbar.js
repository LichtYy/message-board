...
tbitems.push(document.createElement("div"));
tbitems[2].innerHTML = '<a href="/account">我的</a>';
tbitems[2].setAttribute("class", "toolbaritem");
tbitems.push(document.createElement("div"));
tbitems[3].innerHTML = '<a href="/about">关于</a>'
tbitems[3].setAttribute("class", "toolbaritem last");
